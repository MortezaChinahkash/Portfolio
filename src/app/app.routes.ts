...
import { ProjectFitnessTrackerComponent } from './projects/project-fitness-tracker/project-fitness-tracker.component';
...
export const routes: Routes = [
    ...
    {path: 'projects/project-fitness-tracker', component: ProjectFitnessTrackerComponent},
